...
#SBATCH -J bracken-genbank                         # JOB ID
#SBATCH -e /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/bracken-genbank.j%j.err                   # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/bracken-genbank.j%j.out                   # STANDARD OUTPUT FILE TO WRITE TO
