...
inpath = "/group/weimergrp2/genomes/lactococcus/20230803_compare-genbank-sra-art/sampleFiles"
#trimpath = "/group/weimergrp2/genomes/lactococcus/analysis/sampleFiles" #where your successful trims are
outpath = "/group/weimergrp2/genomes/lactococcus/20230803_compare-genbank-sra-art" #where you want output files
...
rule all:
    input:
        outpath+"/population/sourmash-30-genbank-sra-art-comparison/population_sig_compare_31-100k-30-genbank-sra-art-comparison.matrix",
        outpath+"/population/sourmash-30-genbank-sra-art-comparison/population_sig_compare_31-100k-30-genbank-sra-art-comparison.matrix.matrix.png",
        outpath+"/population/roary-30-genbank-sra-art-comparison/gene_presence_absence-30-genbank-sra-art-comparison.csv"
...
rule sour_cmp_31:
    input:
        expand(outpath+"/sampleFiles/{smpl}/sourmash/{smpl}.sig", smpl=sampleids),
    output:
        o1 = outpath+"/population/sourmash-30-genbank-sra-art-comparison/population_sig_compare_31-100k-30-genbank-sra-art-comparison.csv",
        o2 = outpath+"/population/sourmash-30-genbank-sra-art-comparison/population_sig_compare_31-100k-30-genbank-sra-art-comparison.matrix"
    conda:
...
rule sour_plt:
    ...
    output:
        outpath+"/population/sourmash-30-genbank-sra-art-comparison/population_sig_compare_31-100k-30-genbank-sra-art-comparison.matrix.matrix.png"
    params:
        outpath+"/population/sourmash-30-genbank-sra-art-comparison/"
    conda:
        "snakeprograms/ymlfiles/sourmash.yml"
    shell:
        '''
...
rule roary:
    input:
        expand(outpath+"/sampleFiles/{smpl}/prokka/{smpl}.gff", smpl=sampleids),
    output:
        outpath+"/population/roary-30-genbank-sra-art-comparison/core_gene_alignment-30-genbank-sra-art-comparison.aln",
        outpath+"/population/roary-30-genbank-sra-art-comparison/gene_presence_absence-30-genbank-sra-art-comparison.csv"
    params:
        pt = outpath+"/population/roary-30-genbank-sra-art-comparison"
    conda:
