...
filena = "/group/weimergrp/aavalos7/projects/all-lactococcus/20230918_final-genomes-non-llactis-only.txt"
...
rule all:
    input:
        ...
        outpath+"/population/roary_final-lacto-genomes-non-llactis/gene_presence_absence_final-lacto-genomes-non-llactis.csv"
...
rule roary:
    input:
        expand(outpath+"/sampleFiles/{smpl}/prokka/{smpl}.gff", smpl=sampleids),
    output:
        outpath+"/population/roary_final-lacto-genomes-non-llactis/core_gene_alignment_final-lacto-genomes-non-llactis.aln",
        outpath+"/population/roary_final-lacto-genomes-non-llactis/gene_presence_absence_final-lacto-genomes-non-llactis.csv"
    params:
        pt = outpath+"/population/roary_final-lacto-genomes-non-llactis"
    conda:
