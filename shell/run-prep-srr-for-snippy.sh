...
#SBATCH -J prep-srr-for-snippy                         # JOB ID
#SBATCH -e /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/prep-srr-for-snippy.j%j.err                   # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/prep-srr-for-snippy.j%j.out                   # STANDARD OUTPUT FILE TO WRITE TO
...
snakemake -s prep-srr-for-snippy.smk --use-conda --cores 8 --latency-wait 30 -k
