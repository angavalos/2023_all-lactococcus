...
#SBATCH -J prokka-lacto                         # JOB ID
#SBATCH -e /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/prokka-lacto.j%j.err                   # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/prokka-lacto.j%j.out                   # STANDARD OUTPUT FILE TO WRITE TO
...
snakemake -s prokka-lacto.smk --use-conda --cores 4 --latency-wait 30 -k
