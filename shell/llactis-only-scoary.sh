...
#SBATCH -J llactis-only-scoary                        # JOB ID
#SBATCH -D /group/weimergrp2/genomes/lactococcus/20230915_final-lacto-genomes/analysis/population/
#SBATCH -e /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/llactis-only-scoary.j%j.err                   # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/llactis-only-scaory.j%j.out                   # STANDARD OUTPUT FILE TO WRITE TO
...
TRAITS=20230922_llactis-only-traits-for-scoary.csv
PREABS=roary_final-lacto-genomes-llactis_1695142188/gene_presence_absence.csv
OUTPU=20230922_llactis-only-scoary/
