...
path="/group/weimergrp2/genomes/lactococcus/genbank-genomes-analysis/sampleFiles/"
top = pd.DataFrame()
toptop = pd.DataFrame()
bracken_fail = []
brack_pass = []
...
top.to_csv("/group/weimergrp2/genomes/lactococcus/genbank-genomes-analysis/batchReports/allBracken/all-Bracken-v3.csv",index=False)
toptop = top.loc[top.groupby("ID")["fraction_total_reads"].idxmax()]
toptop.to_csv("/group/weimergrp2/genomes/lactococcus/genbank-genomes-analysis/batchReports/allBracken/all-top-Bracken-v3.csv",index=False)
toptoplacto = toptop[toptop["name"].str.contains("Lactococcus")]
toptoplacto.to_csv("/group/weimergrp2/genomes/lactococcus/genbank-genomes-analysis/batchReports/allBracken/all-top-lacto-Bracken-v3.csv",index=False)
