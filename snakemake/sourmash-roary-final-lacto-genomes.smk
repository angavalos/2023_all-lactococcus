...
rule roary:
    input:
        expand(outpath+"/sampleFiles/{smpl}/prokka/{smpl}.gff", smpl=sampleids),
    output:
        outpath+"/population/roary_final-lacto-genomes/core_gene_alignment_final-lacto-genomes.aln",
        outpath+"/population/roary_final-lacto-genoems/gene_presence_absence_final-lacto-genomes.csv"
    params:
        pt = outpath+"/population/roary_final-lacto-genomes"
    conda:
