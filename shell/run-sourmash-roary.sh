...
#SBATCH -J sourmash-roary                         # JOB ID
#SBATCH -e /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/sourmash-roary.j%j.err                   # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/sourmash-roary.j%j.out                   # STANDARD OUTPUT FILE TO WRITE TO
...
snakemake -s sourmash-roary.smk --use-conda --cores 8 --latency-wait 30 -k
