...
#SBATCH -e /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/10-art-checkm.j%j.err                   # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o /group/weimergrp/aavalos7/projects/all-lactococcus/err-out-files/10-art-checkm.j%j.out                   # STANDARD OUTPUT FILE TO WRITE TO
...
snakemake -s 10-art-simulation-checkm-kraken-prokka.smk --use-conda --cores 8 --latency-wait 30 -k
