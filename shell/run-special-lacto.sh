...
#SBATCH -J special-lacto-qc-trim                         # JOB ID
#SBATCH -e special-lacto-qc-trim.j%j.err                   # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o special-lacto-qc-trim.j%j.out                   # STANDARD OUTPUT FILE TO WRITE TO
...
snakemake -s special-lacto.smk --use-conda --cores 1 --latency-wait 30 -k
